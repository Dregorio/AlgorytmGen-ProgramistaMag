...
public class Creature implements Comparable<Creature> {
    ...
    private static String TARGET = "Witaj swiecie w moim programie do symulacji - Grzegorz Grzeda";
    ...
    private String reproduceFromTwoParents(Creature parent1, Creature parent2, int pivot){
        StringBuilder sb = new StringBuilder();
